# Pending suite-wide proposals

This queue contains independently decidable changes to shared policy, compatibility,
tooling or coordination. Each entry has one central issue.
...
- [`standardize_repository_badges_and_suite_identity.md`](standardize_repository_badges_and_suite_identity.md) — [#23](https://github.com/uibcdf/molsyssuite/issues/23) — Standardize repository badges and MolSysSuite role identity. *(measured)*
